...
public class ShapeView extends ImageView {
    ...
    public ShapeView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            mShapeType = a.getInt(R.styleable.ShapeView_shape, mShapeType);
            mDirection = a.getInt(R.styleable.ShapeView_decorations_direction, mDirection);
            mPolygonSides = a.getInt(R.styleable.ShapeView_sides, mPolygonSides);
            mRx = a.getFloat(R.styleable.ShapeView_radius_x, mRx);
            mRy = a.getFloat(R.styleable.ShapeView_radius_y, mRy);
            mDecorationsView = a.getDrawable(R.styleable.ShapeView_decorations_src);
            a.recycle();
        }
    ...
    /**
     * @param direction {@link ShapeView.Direction}
     */
    ...
    /**
     * @param type {@link ShapeView.Shape}
     */
